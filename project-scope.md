...
Use context7 to fetch up-to-date documentation for any library or framework used in this project. Add `use context7` to any prompt involving library APIs, configuration, or version-specific behavior.
